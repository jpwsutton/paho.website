  ...
  <div class="panel-body">
      <table class="table table-hover table-bordered">
           <thead>
             ...
             <tbody>
                 <tr> <th scope="row">Java</th> <td>Mark</td> <td>Otto</td> <td>@mdo</td> </tr>
                 <tr> <th scope="row">Python</th> <td>Jacob</td> <td>Thornton</td> <td>@fat</td> </tr>
                 <tr> <th scope="row">JavaScript</th> <td>Larry</td> <td>the Bird</td> <td>@twitter</td> </tr>
             </tbody>
         </table>

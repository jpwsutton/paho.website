 ...
 *******************************************************************************/
	...
	$Nav->addNavSeparator("Paho", 	"/project");
	$Nav->addCustomNav("Download", "/project/download.php", "_self", 3);
	$Nav->addCustomNav("Documentation", "/project/documentation", "_blank", 3);
	$Nav->addCustomNav("Support", "/project/support", "_blank", 3);
	$Nav->addCustomNav("Getting Involved", "/project/developers", "_blank", 3);
	
	# Define keywords, author and title here, or in each PHP page specifically
	$pageKeywords	= "paho, m2m, Machine-to-Machine, Internet of Things, IoT";
	$pageAuthor		= "Scott de Deugd";
	# $pageTitle 		= "Paho";
	...
	$App->AddExtraHtmlHeader('<link rel="stylesheet" type="text/css" href="/paho/style.css"/>'."\n");
	
	# Following link needed to add Paho header to all pages
